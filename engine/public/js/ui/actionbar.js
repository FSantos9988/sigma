...
$.widget("znetdk.zdkactionbar", {
    ...
    _create: function () {
        ...
        if (filterRows.length) {
            ...
            this.filterClear.get(0).type = 'button';
            this.filterSearch.get(0).type = 'submit';
    ...
    editRow: function(row) {
        var editButton = this.element.find('button.zdk-bt-edit');
        if (editButton.length === 1 && this.options.dialogID && this.options.datatableID) {
            // Get the dialog title
    ...
    _storeDefaultNumberOfSelectedRows: function(numberOfRows) {
        ...
        return znetdk.storeLocalSettings(storageKey, numberOfRows);
    },

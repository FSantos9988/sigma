...
$(function () {
    ...
    $.widget("primeui.puibasemenu", $.primeui.puibasemenu, {
        _create: function() {
            this._super();
            this.refreshFaIconColor();
        },
        refreshFaIconColor: function() {
            ...
            this.element.find("span.ui-icon-triangle-1-e")
                    .removeClass('ui-icon').addClass('fa fa-caret-right fa-lg');
        }
    });
});